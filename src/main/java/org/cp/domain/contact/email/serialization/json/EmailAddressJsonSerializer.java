...
/**
 * {@link JsonSerializer} implementation for {@link EmailAddress}.
 *
 * @author John Blum
 ...
 * @since 0.3.0
 */
public class EmailAddressJsonSerializer extends AbstractJsonSerializer<EmailAddress> {

  @Override
  protected Class<EmailAddress> getType() {
