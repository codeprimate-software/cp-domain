...
/**
 * {@link Enum Enumeration} for different races as defined by the OMB standards.
 *
 * @author John J. Blum
 * @see java.lang.Enum
 * @since 0.1.0
...
public enum Race {
  ...
  /**
   * Constructs a new {@link Race} initialized with the given {@link String abbreviation} and {@link String name}
   * for the {@link Race}.
   *
