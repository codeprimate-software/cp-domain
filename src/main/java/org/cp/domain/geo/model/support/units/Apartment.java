...
public class Apartment extends Unit {
  ...
  /**
   * Factory method used to construct a new {@link Apartment} copied from the given, required {@link Unit}.
   *
  ...
  /**
   * Factory method used to construct a new {@link Apartment} initialized with the given, required {@link String number}
