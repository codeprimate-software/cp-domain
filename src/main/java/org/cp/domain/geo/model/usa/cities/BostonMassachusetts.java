...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Boston} {@link State#MASSACHUSETTS},
 ...
 */
@Immutable
public final class BostonMassachusetts extends ImmutableUnitedStatesCity {

  public static final BostonMassachusetts INSTANCE = new BostonMassachusetts();

  private BostonMassachusetts() {
    super("Boston");
  }
