...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Concord} {@link State#NEW_HAMPSHIRE},
 ...
 */
@Immutable
public final class ConcordNewHampshire extends ImmutableUnitedStatesCity {

  public static final ConcordNewHampshire INSTANCE = new ConcordNewHampshire();

  private ConcordNewHampshire() {
    super("Concord");
  }
