...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Denver} {@link State#COLORADO},
 ...
 */
@Immutable
public final class DenverColorado extends ImmutableUnitedStatesCity {

  public static final DenverColorado INSTANCE = new DenverColorado();

  private DenverColorado() {
    super("Denver");
  }
