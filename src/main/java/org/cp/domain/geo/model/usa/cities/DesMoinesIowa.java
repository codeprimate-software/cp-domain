...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Des Moines} {@link State#IOWA},
 ...
 */
@Immutable
public final class DesMoinesIowa extends ImmutableUnitedStatesCity {

  public static final DesMoinesIowa INSTANCE = new DesMoinesIowa();

  private DesMoinesIowa() {
    super("Des Moines");
  }
