...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Frankfurt} {@link State#KENTUCKY},
 ...
 */
@Immutable
public final class FrankfortKentucky extends ImmutableUnitedStatesCity {

  public static final FrankfortKentucky INSTANCE = new FrankfortKentucky();

  private FrankfortKentucky() {
    super("Frankfort");
  }
