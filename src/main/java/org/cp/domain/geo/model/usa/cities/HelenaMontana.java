...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Helena} {@link State#MONTANA},
 ...
 */
@Immutable
public final class HelenaMontana extends ImmutableUnitedStatesCity {

  public static final HelenaMontana INSTANCE = new HelenaMontana();

  private HelenaMontana() {
    super("Helena");
  }
