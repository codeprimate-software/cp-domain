...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Honolulu} {@link State#HAWAII},
 ...
 */
@Immutable
public final class HonoluluHawaii extends ImmutableUnitedStatesCity {

  public static final HonoluluHawaii INSTANCE = new HonoluluHawaii();

  private HonoluluHawaii() {
    super("Honolulu");
  }
