...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Jefferson City} {@link State#MISSOURI},
 ...
 */
@Immutable
public final class JeffersonCityMissouri extends ImmutableUnitedStatesCity {

  public static final JeffersonCityMissouri INSTANCE = new JeffersonCityMissouri();

  private JeffersonCityMissouri() {
    super("Jefferson City");
  }
