...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Lincoln} {@link State#NEBRASKA},
 ...
 */
@Immutable
public final class LincolnNebraska extends ImmutableUnitedStatesCity {

  public static final LincolnNebraska INSTANCE = new LincolnNebraska();

  private LincolnNebraska() {
    super("Lincoln");
  }
