...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Montgomery} {@link State#ALABAMA},
 ...
 */
@Immutable
public final class MontgomeryAlabama extends ImmutableUnitedStatesCity {

  public static final MontgomeryAlabama INSTANCE = new MontgomeryAlabama();

  private MontgomeryAlabama() {
    super("Montgomery");
  }
