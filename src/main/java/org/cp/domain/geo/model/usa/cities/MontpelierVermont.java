...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Montpelier} {@link State#VERMONT},
 ...
 */
@Immutable
public final class MontpelierVermont extends ImmutableUnitedStatesCity {

  public static final MontpelierVermont INSTANCE = new MontpelierVermont();

  private MontpelierVermont() {
    super("Montpelier");
  }
