...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Phoenix} {@link State#ARIZONA},
 ...
 */
@Immutable
public final class PhoenixArizona extends ImmutableUnitedStatesCity {

  public static final PhoenixArizona INSTANCE = new PhoenixArizona();

  private PhoenixArizona() {
    super("Phoenix");
  }
