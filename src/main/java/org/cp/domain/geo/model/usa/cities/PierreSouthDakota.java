...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Pierre} {@link State#SOUTH_DAKOTA},
 ...
 */
@Immutable
public final class PierreSouthDakota extends ImmutableUnitedStatesCity {

  public static final PierreSouthDakota INSTANCE = new PierreSouthDakota();

  private PierreSouthDakota() {
    super("Pierre");
  }
