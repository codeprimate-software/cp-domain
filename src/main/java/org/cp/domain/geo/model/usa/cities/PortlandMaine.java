...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Portland} {@link State#MAINE},
 ...
 */
@Immutable
public final class PortlandMaine extends ImmutableUnitedStatesCity {

  public static final PortlandMaine INSTANCE = new PortlandMaine();

  private PortlandMaine() {
    super("Portland");
  }
