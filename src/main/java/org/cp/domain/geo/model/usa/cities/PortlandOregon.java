...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Portland} {@link State#OREGON},
 ...
 */
@Immutable
public final class PortlandOregon extends ImmutableUnitedStatesCity {

  public static final PortlandOregon INSTANCE = new PortlandOregon();

  private PortlandOregon() {
    super("Portland");
  }
