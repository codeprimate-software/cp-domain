...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Salt Lake City} {@link State#UTAH},
 ...
 */
@Immutable
public final class SaltLakeCityUtah extends ImmutableUnitedStatesCity {

  public static final SaltLakeCityUtah INSTANCE = new SaltLakeCityUtah();

  private SaltLakeCityUtah() {
    super("Salt Lake City");
  }
