...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Santa Fe} {@link State#NEW_MEXICO},
 ...
 */
@Immutable
public final class SantaFeNewMexico extends ImmutableUnitedStatesCity {

  public static final SantaFeNewMexico INSTANCE = new SantaFeNewMexico();

  private SantaFeNewMexico() {
    super("Santa Fe");
  }
