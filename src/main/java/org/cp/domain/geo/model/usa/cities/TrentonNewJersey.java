...
/**
 * {@link ImmutableUnitedStatesCity} modeling the city of {@literal Trenton} {@link State#NEW_JERSEY},
 ...
 */
@Immutable
public final class TrentonNewJersey extends ImmutableUnitedStatesCity {

  public static final TrentonNewJersey INSTANCE = new TrentonNewJersey();

  private TrentonNewJersey() {
    super("Trenton");
  }
