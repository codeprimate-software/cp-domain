 ...
 * @since 0.1.0
 */
public class OfficeUnitTests extends AbstractConcreteUnitUnitTests<Office> {

  @Override
  protected Function<Unit, Office> fromUnitFactoryMethod() {
    return Office::from;
  }

  @Override
  protected Function<String, Office> numberFactoryMethod() {
    return Office::number;
  }

  @Override
  protected Function<String, Office> unitConstructor() {
    return Office::new;
  }

  @Override
  protected Type getExpectedUnitType() {
    return Unit.Type.OFFICE;
  }
}
