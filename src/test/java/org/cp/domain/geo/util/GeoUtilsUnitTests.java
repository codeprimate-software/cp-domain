 ...
 * @see org.cp.domain.geo.util.GeoUtils
 * @since 0.1.0
 */
public class GeoUtilsUnitTests {

  @Test
  void resolvesCountryToCountry() {
    assertThat(GeoUtils.resolveCountry(Country.GERMANY)).isEqualTo(Country.GERMANY);
  }
